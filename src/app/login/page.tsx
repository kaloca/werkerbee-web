									...
									<div className='relative flex items-center justify-center'>
										<div className='flex flex-row w-full'>
											<input
												...
												className='h-11 bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2 hide'
											/>
										<button 
											className='w-9 mt-2 h-11 p-1 bg-gray-200 border rounded focus:outline-non border-gray-600 text-sm font-medium leading-none text-gray-800'
