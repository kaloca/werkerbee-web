...
import WerkerBeeLogo from '../assets/werkerbeelogo.png'

const selected = 'text-indigo-700 tracking-normal border-b-2 border-indigo-700'
const normal = 'text-gry-800 tracking-normal'
