			...
			<div className='flex-none sm:flex'>
				...
				<div className='flex-auto sm:ml-5 justify-evenly'>
						...
						<div className='flex items-center'>
							<div className='flex flex-col'>
								...
								<div className='flex flex-row'>
									<Rating rating={3.4} />
									<div className='flex-auto text-gray-500 my-1 ml-3'>
					...
					<div className='my-3 mx-1'>
						<p className='text-semibold'>Offered Jobs:</p>
						{jobTypes.map((jobType) => (
							<div
								key={jobType.type}
								className='flex flex-row my-1 text-gray-500'
							>
								<p className='first-letter:capitalize'>{jobType.type}</p>
								{rating != null && <Rating rating={jobType.rating} />}
							</div>
						))}
					</div>
